            ...
            <form action="{{ route('programas.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="prog_Denominacion" id="prog_Denominacion"
                                   ...
                                   value="{{ old('prog_Denominacion') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="prog_version" id="prog_version"
                                   ...
                                   value="{{ old('prog_version', 1) }}" required>
                            @error('prog_version')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="prog_Estado" id="prog_Estado" class="form-control">
                                ...
                                <option value="Activo" {{ old('prog_Estado') == 'Activo' ? 'selected' : '' }}>Activo</option>
                                <option value="Inactivo" {{ old('prog_Estado') == 'Inactivo' ? 'selected' : '' }}>Inactivo</option>
                                <option value="En revisión" {{ old('prog_Estado') == 'En revisión' ? 'selected' : '' }}>En revisión</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="prog_NivelFormacion" id="prog_NivelFormacion"
                                   class="form-control" value="{{ old('prog_NivelFormacion') }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="prog_HorasEstimadas" id="prog_HorasEstimadas"
                                   ...
                                   value="{{ old('prog_HorasEstimadas') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="prog_Creditos" id="prog_Creditos"
                                   ...
                                   value="{{ old('prog_Creditos') }}" required>
                            @error('prog_Creditos')
                            <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="prog_DuracionMeses" id="prog_DuracionMeses"
                                   ...
                                   value="{{ old('prog_DuracionMeses') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="prog_etapaLectiva" id="prog_etapaLectiva"
                                   ...
                                   value="{{ old('prog_etapaLectiva') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="prog_etapaProductiva" id="prog_etapaProductiva"
                                   ...
                                   value="{{ old('prog_etapaProductiva') }}" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="prog_totalHoras" id="prog_totalHoras"
                                   ...
                                   value="{{ old('prog_totalHoras') }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="prog_Descripcion" id="prog_Descripcion"
                              ...
                              rows="3" required>{{ old('prog_Descripcion') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="prog_justificacion" id="prog_justificacion"
                              ...
                              rows="3" required>{{ old('prog_justificacion') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="prog_metodologia" id="prog_metodologia"
                              ...
                              rows="3" required>{{ old('prog_metodologia') }}</textarea>
